...
#        print real_title
    ...
    for f in fields:
        if tit == 1:
            ...
            if match not in titles_to_order:
...
def main(args):
    ...
    pages_by_issues = {
        WARNING_PAGE_WITH_INVALID_FIELD : [],
        WARNING_PAGE_WITH_FIELDS_IN_WRONG_ORDER : [],
        WARNING_PAGE_WITH_COMMENT : [],
        WARNING_PAGE_WITH_TEXT_BEFORE_DEF : [],
        ...
        WARNING_2nd_LEVEL_TITLE_FROM_LIST : [],
